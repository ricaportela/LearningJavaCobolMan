...
public class DistribuidorData extends GenericoData<Classe> {
	private final static String LISTAR_TODOS = "SELECT id, agencia, pagamento FROM distribuidor";
	private final static String BUSCAR_ID = "SELECT id FROM distribuidor WHERE id = ?";
	private final static String INCLUIR = "INSERT INTO distribuidor (id, agencia, pagamento) VALUES (?,?,?)";
	private final static String ATUALIZAR = "UPDATE distribuidor SET agencia=? WHERE id=?";
	private final static String DELETAR = "DELETE FROM distribuidor WHERE id=?";
